...
trainData = np.genfromtxt("./cfb-50k.dat", delimiter=' ', dtype=int)
xData = trainData[::2]
yData = trainData[1::2]
del trainData

testData = np.loadtxt("./cfb-10k-test.dat", delimiter=' ', dtype=int)
...
while True:
    ...
    if(initial == False):
        ...
        counterModel += 1
        model.add(Dense(SIZE*16, input_dim=SIZE, activation='relu'))
